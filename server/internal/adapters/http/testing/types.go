...
type pointDTO struct {
	...
	SupportNeedLevel          int     `json:"supportNeedLevel,omitempty"`
	SecondarySupportNeedLevel int     `json:"secondarySupportNeedLevel,omitempty"`
	Score                     float64 `json:"score,omitempty"`
	SecondaryScore            float64 `json:"secondaryScore,omitempty"`
