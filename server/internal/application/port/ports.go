...
// Конкретные реализации живут в infrastructure (адаптер Mongo, примитивы
// безопасности), благодаря чему use case не зависят от фреймворков и БД — как
// требует чистая архитектура.
//
...
// (Yandex) живёт в infrastructure/oauth. Configured сообщает, заданы ли секреты.
